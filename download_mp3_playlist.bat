...
.\yt-dlp.exe -i -U --geo-bypass --yes-playlist --add-metadata --embed-thumbnail -f bestaudio -x --audio-format mp3 -w -c -a "download_mp3_list.txt" --output "downloads\%%(playlist_title)s\%%(title)s.%%(ext)s" --download-archive "archive.txt"
