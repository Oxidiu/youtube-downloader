...
youtube-dl.exe -i --geo-bypass --yes-playlist --abort-on-unavailable-fragment --add-metadata --embed-thumbnail -x --audio-format mp3 -w -c -a "download_list.txt" --output "downloads\%%(title)s.%%(ext)s" --download-archive "archive.txt"
